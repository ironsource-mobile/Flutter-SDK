...
internal class LevelPlayNativeAdView(
    ...
    override fun onAdClicked(nativeAd: LevelPlayNativeAd?, adInfo: AdInfo?) {
        ...
        methodChannel?.let { channel ->
            invokeMethodOnUiThread(channel, "onAdClicked", LevelPlayUtils.hashMapOfIronSourceNativeAdAndAdInfo(nativeAd, adInfo))
        }
    }
    ...
    override fun onAdImpression(nativeAd: LevelPlayNativeAd?, adInfo: AdInfo?) {
        ...
        methodChannel?.let { channel ->
            invokeMethodOnUiThread(channel, "onAdImpression", LevelPlayUtils.hashMapOfIronSourceNativeAdAndAdInfo(nativeAd, adInfo))
        }
    }
    ...
    override fun onAdLoadFailed(nativeAd: LevelPlayNativeAd?, error: IronSourceError?) {
        ...
        methodChannel?.let { channel ->
            invokeMethodOnUiThread(channel, "onAdLoadFailed", LevelPlayUtils.hashMapOfIronSourceNativeAdAndError(nativeAd, error))
        }
    }
    ...
    override fun onAdLoaded(nativeAd: LevelPlayNativeAd?, adInfo: AdInfo?) {
        ...
        methodChannel?.let { channel ->
            invokeMethodOnUiThread(channel, "onAdLoaded", LevelPlayUtils.hashMapOfIronSourceNativeAdAndAdInfo(nativeAd, adInfo))
        }
