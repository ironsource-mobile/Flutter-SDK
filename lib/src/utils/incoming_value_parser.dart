...
class IncomingValueParser {
  ...
  /// [arguments] to [IronSourceRewardedVideoPlacement]
  /// - Throws [ArgumentError] if [arguments] is null.
  static IronSourceRewardedVideoPlacement getRewardedVideoPlacement(dynamic arguments) {
    final placementName = getValueForKey<String>(IronConstKey.PLACEMENT_NAME, arguments);
    final rewardName = getValueForKey<String>(IronConstKey.REWARD_NAME, arguments);
    final rewardAmount = getValueForKey<int>(IronConstKey.REWARD_AMOUNT, arguments);
  ...
  static IronSourceAdInfo getIronSourceAdInfo(dynamic arguments) {
    final String? auctionId = getValueForKey<String?>(IronConstKey.AUCTION_ID, arguments);
    final String? adUnit = getValueForKey<String?>(IronConstKey.AD_UNIT, arguments);
    final String? adNetwork = getValueForKey<String?>(IronConstKey.AD_NETWORK, arguments);
    final String? ab = getValueForKey<String?>(IronConstKey.AB, arguments);
    final String? country = getValueForKey<String?>(IronConstKey.COUNTRY, arguments);
    final String? instanceId = getValueForKey<String?>(IronConstKey.INSTANCE_ID, arguments);
    final String? instanceName = getValueForKey<String?>(IronConstKey.INSTANCE_NAME, arguments);
    final String? segmentName = getValueForKey<String?>(IronConstKey.SEGMENT_NAME, arguments);
    final double? revenue = getValueForKey<double?>(IronConstKey.REVENUE, arguments);
    final String? precision = getValueForKey<String?>(IronConstKey.PRECISION, arguments);
    final String? encryptedCPM = getValueForKey<String?>(IronConstKey.ENCRYPTED_CPM, arguments);
  ...
  static IronSourceImpressionData? getIronSourceImpressionData(dynamic arguments) {
    if (arguments == null) {
      return null;
    }
    final String? auctionId = getValueForKey<String?>(IronConstKey.AUCTION_ID, arguments);
    ...
    final String? ab = getValueForKey<String?>(IronConstKey.AB, arguments);
    final String? segmentName = getValueForKey<String?>(IronConstKey.SEGMENT_NAME, arguments);
    final String? placement = getValueForKey<String?>(IronConstKey.PLACEMENT, arguments);
    final String? adNetwork = getValueForKey<String?>(IronConstKey.AD_NETWORK, arguments);
    final String? instanceName = getValueForKey<String?>(IronConstKey.INSTANCE_NAME, arguments);
    final String? instanceId = getValueForKey<String?>(IronConstKey.INSTANCE_ID, arguments);
    final double? revenue = getValueForKey<double?>(IronConstKey.REVENUE, arguments);
    final String? precision = getValueForKey<String?>(IronConstKey.PRECISION, arguments);
    final double? lifetimeRevenue = getValueForKey<double?>(IronConstKey.LIFETIME_REVENUE, arguments);
    final String? encryptedCPM = getValueForKey<String?>(IronConstKey.ENCRYPTED_CPM, arguments);
